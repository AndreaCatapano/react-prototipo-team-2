...
export default function AccordioTrip({ dataId }) {
  const currentTrip = travelDataDemo.find(
    (trip) => trip.id === parseInt(dataId)
  );
    ...
    <>
      <div className="accordion text-white" id="accordionTrip">
        ...
        >
          ...
          >
            <button
              className="accordion-button collapsed fs-4 text-white bg-transparent"
              type="button"
          ...
          <div
            ...
            data-bs-parent="#accordionTrip"
          >
            <div
              className="accordion-body text-white"
              style={{
                backgroundColor: "rgba(0, 0, 0, 0.3)",
            ...
            >
              <p>
                Destinazione: <strong>{currentTrip.destination}</strong>
              </p>
              <p>
                Dal <strong>{currentTrip.departure}</strong> al{" "}
                <strong>{currentTrip.return}</strong>
              </p>
